...
//        chartView.legend = l
    ...
    func setChartData() {
        ...
        set1.fill = ColorFill(color: UIColor(red: 103 / 255, green: 110 / 255, blue: 129 / 255, alpha: 1))
        ...
        set2.fill = ColorFill(color: UIColor(red: 121 / 255, green: 162 / 255, blue: 175 / 255, alpha: 1))
    ...
    override func optionTapped(_ option: Option) {
        ...
        case .toggleHighlightCircle:
            for case let set as RadarChartDataSet in data {
                set.isDrawHighlightCircleEnabled.toggle()
            }
            chartView.setNeedsDisplay()
